...
var script = {
  ...
  methods: {
    ...
    _getPTValue: function _getPTValue() {
      ...
      var merged = mergeProps(self, globalPT, key !== 'transition' && _objectSpread(_objectSpread({}, key === 'root' && this.$.type.name === this.$options.hostName && _defineProperty({}, "".concat(datasetPrefix, "name"), ObjectUtils.toFlatCase(this.$.type.name))), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), ObjectUtils.toFlatCase(key))));
      return merged;
      /*
